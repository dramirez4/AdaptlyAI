...
def process_audio():
    ...
    transcript = speech_to_text("/users/json/desktop/test.wav")
...
# post deck/new -> give query, gen outline
# get deck/deck-id:/slide-idx -> get/gen slide details, return updated outline and dlide details
# get deck/deck-id:/slide-idx/confused -> gen slide details for a confused user, return updated outline and dlide details
